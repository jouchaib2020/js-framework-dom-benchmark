...
export const cpuBenchmarkInfosArray: Array<CPUBenchmarkInfo> = [
  {
    ...
    label: "create rows",
    warmupCount: 5,
    description: "creating 1,000 nodes.",
    type: BenchmarkType.CPU,
    allowBatching: true,
  ...
  },
  {
    ...
    warmupCount: 5,
    description: "updating all 1,000 nodes.",
    type: BenchmarkType.CPU,
    allowBatching: true,
    layoutEventRequired: true,
    additionalNumberOfRuns: 0,
  },
  {
    ...
    warmupCount: 3,
    description: "updating the middle node of 1,000 nodes.",
    type: BenchmarkType.CPU,
    allowBatching: true,
    layoutEventRequired: true,
    additionalNumberOfRuns: 0,
  },
  {
    ...
    label: "select node",
    warmupCount: 5,
    description: "highlighting a selected node.",
    type: BenchmarkType.CPU,
    allowBatching: true,
    layoutEventRequired: false,
    additionalNumberOfRuns: 2,
  },
  {
    id: Benchmark._05,
    label: "swap two leaf nodes",
    warmupCount: 5,
    description: "swapping two leaf nodes of 1,000 nodes.",
    type: BenchmarkType.CPU,
    allowBatching: true,
    layoutEventRequired: true,
    additionalNumberOfRuns: 0,
